            ...
            <div className='col-md-6 d-flex justify-content-center'>
                <form onSubmit={handleRegister}>
                    ...
                    <div className='input-group mb-3'>
                        <input type="text" placeholder='Nombre' className='form-control form-control-lg bg-light fs-6'
                            value={nombreRegister} onChange={(e) => setNombreRegister(e.target.value)} />
                    </div>
                    <div className='input-group mb-3'>
                        <input type="email" placeholder='Correo' className='form-control form-control-lg bg-light fs-6'
                            value={correoRegister} onChange={(e) => setCorreoRegister(e.target.value)} />
                    </div>
                    <div className='input-group mb-3'>
                ...
                <form onSubmit={handleLogin}>
                    ...
                    <div className='input-group mb-5 d-flex justify-content-between'>
                        <div className='form-check'>
                            ...
                            <label htmlFor="formcheck" className='form-check-label text-secondary'><small>Recordar</small></label>
                        </div>
